  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        ...
        description: '<div class="tour-step-description"><p>Sub2API is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p><b>Core Features:</b></p><ul><li><b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li><b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li><b>Key Distribution</b> - Generate independent API Keys for users</li><li><b>Billing Control</b> - Flexible rate and quota management</li></ul><p><strong>Let\'s complete the initial setup in 3 minutes</strong></p></div>',
        nextBtn: 'Start Setup',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: 'Step 1: Group Management',
        description: '<div class="tour-step-description"><p><b>What is a Group?</b></p><p>Groups are the core concept of Sub2API, like a "service package":</p><ul><li>Each group can contain multiple upstream accounts</li><li>Each group has independent billing multiplier</li><li>Can be set as public or exclusive</li></ul><p class="tour-success-box"><b>Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p><strong>Click "Group Management" on the left sidebar</strong></p></div>'
      },
      createGroup: {
        title: 'Create New Group',
        description: '<div class="tour-step-description"><p>Let\'s create your first group.</p><p class="tour-info-box"><b>Tip:</b> Recommend creating a test group first to familiarize yourself with the process</p><p><strong>Click the "Create Group" button</strong></p></div>'
      },
      groupName: {
        title: '1. Group Name',
        description: '<div class="tour-step-description"><p>Give your group an easy-to-identify name.</p><div class="tour-success-box"><b>Naming Suggestions:</b><ul><li>"Test Group" - For testing</li><li>"VIP Premium" - High-quality service</li><li>"Free Trial" - Trial version</li></ul></div><p><em>Click "Next" when done</em></p></div>',
        nextBtn: 'Next'
      },
      groupPlatform: {
        title: '2. Select Platform',
        description: '<div class="tour-step-description"><p>Choose the AI platform this group supports.</p><div class="tour-info-box"><b>Platform Guide:</b><ul><li><b>Anthropic</b> - Claude models</li><li><b>OpenAI</b> - GPT models</li><li><b>Google</b> - Gemini models</li></ul></div><p><em>One group can only have one platform</em></p></div>',
        nextBtn: 'Next'
      },
      groupMultiplier: {
        title: '3. Rate Multiplier',
        description: '<div class="tour-step-description"><p>Set the billing multiplier to control user charges.</p><div class="tour-warning-box"><b>Billing Rules:</b><ul><li><b>1.0</b> - Original price (cost price)</li><li><b>1.5</b> - User consumes $1, charged $1.5</li><li><b>2.0</b> - User consumes $1, charged $2</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p><em>Recommend setting test group to 1.0</em></p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
        title: '4. Exclusive Group (Optional)',
        description: '<div class="tour-step-description"><p>Control group visibility and access permissions.</p><div class="tour-info-box"><b>Permission Guide:</b><ul><li><b>Off</b> - Public group, visible to all users</li><li><b>On</b> - Exclusive group, only for specified users</li></ul></div><p class="tour-success-box"><b>Use Cases:</b> VIP exclusive, internal testing, special customers</p></div>',
        nextBtn: 'Next'
      },
      groupSubmit: {
        title: 'Save Group',
        description: '<div class="tour-step-description"><p>Confirm the information and click create to save the group.</p><p class="tour-warning-box"><b>Note:</b> Platform type cannot be changed after creation, but other settings can be edited anytime</p><p class="tour-success-box"><b>Next Step:</b> After creation, we\'ll add upstream accounts to this group</p><p><strong>Click "Create" button</strong></p></div>'
      },
      accountManage: {
        title: 'Step 2: Add Account',
        description: '<div class="tour-step-description"><p><b>Great! Group created successfully</b></p><p>Now add upstream AI service accounts to enable actual service delivery.</p><div class="tour-info-box"><b>Account Purpose:</b><ul><li>Connect to upstream AI services (Claude, GPT, etc.)</li><li>One group can contain multiple accounts (load balancing)</li><li>Supports OAuth and Session Key methods</li></ul></div><p><strong>Click "Account Management" on the left sidebar</strong></p></div>'
      },
      createAccount: {
        title: 'Add New Account',
        description: '<div class="tour-step-description"><p>Click the button to start adding your first upstream account.</p><p class="tour-success-box"><b>Tip:</b> Recommend using OAuth method - more secure and no manual key extraction needed</p><p><strong>Click "Add Account" button</strong></p></div>'
      },
      accountName: {
        title: '1. Account Name',
        description: '<div class="tour-step-description"><p>Set an easy-to-identify name for the account.</p><p class="tour-success-box"><b>Naming Suggestions:</b> "Claude Main", "GPT Backup 1", "Test Account", etc.</p></div>',
        nextBtn: 'Next'
      },
      accountPlatform: {
        title: '2. Select Platform',
        description: '<div class="tour-step-description"><p>Choose the service provider platform for this account.</p><p class="tour-warning-box"><b>Important:</b> Platform must match the group you just created</p></div>',
        nextBtn: 'Next'
      },
      accountType: {
        title: '3. Authorization Method',
        description: '<div class="tour-step-description"><p>Choose the account authorization method.</p><div class="tour-success-box"><b>Recommended: OAuth Method</b><ul><li>No manual key extraction needed</li><li>More secure with auto-refresh support</li><li>Works with Claude Code, ChatGPT OAuth</li></ul></div><div class="tour-info-box"><b>Session Key Method</b><ul><li>Requires manual extraction from browser</li><li>May need periodic updates</li><li>For platforms without OAuth support</li></ul></div></div>',
        nextBtn: 'Next'
      },
      accountPriority: {
        title: '4. Priority (Optional)',
        description: '<div class="tour-step-description"><p>Set the account call priority.</p><div class="tour-info-box"><b>Priority Rules:</b><ul><li>Lower number = higher priority</li><li>System uses low-value accounts first</li><li>Same priority = random selection</li></ul></div><p class="tour-success-box"><b>Use Case:</b> Set main account to lower value, backup accounts to higher value</p></div>',
        nextBtn: 'Next'
      },
      accountGroups: {
        title: '5. Assign Groups',
        description: '<div class="tour-step-description"><p><b>Key Step!</b> Assign the account to the group you just created.</p><div class="tour-error-box"><b>Important Reminder:</b><ul><li>Must select at least one group</li><li>Unassigned accounts cannot be used</li><li>One account can be assigned to multiple groups</li></ul></div><p class="tour-success-box"><b>Tip:</b> Select the test group you just created</p></div>',
        nextBtn: 'Next'
      },
      accountSubmit: {
        title: 'Save Account',
        description: '<div class="tour-step-description"><p>Confirm the information and click save.</p><div class="tour-info-box"><b>OAuth Flow:</b><ul><li>Will redirect to service provider page after clicking save</li><li>Complete login and authorization on provider page</li><li>Auto-return after successful authorization</li></ul></div><p class="tour-success-box"><b>Next Step:</b> After adding account, we\'ll create an API key</p><p><strong>Click "Save" button</strong></p></div>'
      },
      keyManage: {
        title: 'Step 3: Generate Key',
        description: '<div class="tour-step-description"><p><b>Congratulations! Account setup complete</b></p><p>Final step: generate an API Key to test if the service works properly.</p><div class="tour-info-box"><b>API Key Purpose:</b><ul><li>Credential for calling AI services</li><li>Each key is bound to one group</li><li>Can set quota and expiration</li><li>Supports independent usage statistics</li></ul></div><p><strong>Click "API Keys" on the left sidebar</strong></p></div>'
      },
      createKey: {
        title: 'Create Key',
        description: '<div class="tour-step-description"><p>Click the button to create your first API Key.</p><p class="tour-success-box"><b>Tip:</b> Copy and save immediately after creation - key is only shown once</p><p><strong>Click "Create Key" button</strong></p></div>'
      },
      keyName: {
        title: '1. Key Name',
        description: '<div class="tour-step-description"><p>Set an easy-to-manage name for the key.</p><p class="tour-success-box"><b>Naming Suggestions:</b> "Test Key", "Production", "Mobile", etc.</p></div>',
        nextBtn: 'Next'
      },
      keyGroup: {
        title: '2. Select Group',
        description: '<div class="tour-step-description"><p>Select the group you just configured.</p><div class="tour-info-box"><b>Group Determines:</b><ul><li>Which accounts this key can use</li><li>What billing multiplier applies</li><li>Whether it\'s an exclusive key</li></ul></div><p class="tour-success-box"><b>Tip:</b> Select the test group you just created</p></div>',
        nextBtn: 'Next'
      },
      keySubmit: {
        title: 'Generate and Copy',
        description: '<div class="tour-step-description"><p>System will generate a complete API Key after clicking create.</p><div class="tour-error-box"><b>Important Reminder:</b><ul><li>Key is only shown once, copy immediately</li><li>Need to regenerate if lost</li><li>Keep it safe, don\'t share with others</li></ul></div><div class="tour-success-box"><b>Next Steps:</b><ul><li>Copy the generated sk-xxx key</li><li>Use in any OpenAI-compatible client</li><li>Start experiencing AI services!</li></ul></div><p><strong>Click "Create" button</strong></p></div>'
      }
    },
    // User tour steps
    user: {
      welcome: {
        title: 'Welcome to Sub2API',
        description: '<div class="tour-step-description"><p>Hello! Welcome to the Sub2API AI service platform.</p><p><b>Quick Start:</b></p><ul><li>Create API Key</li><li>Copy key to your application</li><li>Start using AI services</li></ul><p><strong>Just 1 minute, let\'s get started</strong></p></div>',
        nextBtn: 'Start',
        prevBtn: 'Skip'
      },
      keyManage: {
        title: 'API Key Management',
        description: '<div class="tour-step-description"><p>Manage all your API access keys here.</p><p class="tour-info-box"><b>What is an API Key?</b><br/>An API key is your credential for accessing AI services, like a key that allows your application to call AI capabilities.</p><p><strong>Click to enter key page</strong></p></div>'
      },
      createKey: {
        title: 'Create New Key',
        description: '<div class="tour-step-description"><p>Click the button to create your first API key.</p><p class="tour-success-box"><b>Tip:</b> Key is only shown once after creation, make sure to copy and save</p><p><strong>Click "Create Key"</strong></p></div>'
      },
      keyName: {
        title: 'Key Name',
        description: '<div class="tour-step-description"><p>Give your key an easy-to-identify name.</p><p class="tour-success-box"><b>Examples:</b> "My First Key", "For Testing", etc.</p></div>',
        nextBtn: 'Next'
      },
      keyGroup: {
        title: 'Select Group',
        description: '<div class="tour-step-description"><p>Select the service group assigned by the administrator.</p><p class="tour-info-box"><b>Group Info:</b><br/>Different groups may have different service quality and billing rates, choose according to your needs.</p></div>',
        nextBtn: 'Next'
      },
      keySubmit: {
        title: 'Complete Creation',
        description: '<div class="tour-step-description"><p>Click to confirm and create your API key.</p><div class="tour-error-box"><b>Important:</b><ul><li>Copy the key (sk-xxx) immediately after creation</li><li>Key is only shown once, need to regenerate if lost</li></ul></div><p class="tour-success-box"><b>How to Use:</b><br/>Configure the key in any OpenAI-compatible client (like ChatBox, OpenCat, etc.) and start using!</p><p><strong>Click "Create" button</strong></p></div>'
      }
    }
  },
